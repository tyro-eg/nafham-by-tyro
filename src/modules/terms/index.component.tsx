...
const Terms = () => (
  <div className="terms-container container">
    ...
    <p>
      ...
      of nafhambytyro’s Website, located at https://nafhambytyro.com
    </p>
    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use Tyro if you do not agree to take all of the terms
      and conditions stated on this page. Our Terms and Conditions were created
      with the help of the Terms And Conditions Generator and the Free Terms &
    ...
    <p>
      We employ the use of cookies. By accessing Tyro, you agreed to use cookies
      in agreement with the Tyro-App’s Privacy Policy.
    </p>
    <p>
    ...
    <p>
      Unless otherwise stated, Tyro-App and/or its licensors own the
      intellectual property rights for all material on Tyro. All intellectual
      property rights are reserved. You may access this from Tyro for your own
      personal use subjected to restrictions set in these terms and conditions.
    </p>
    <p>You must not:</p>
    <ul>
      <li>Republish material from Tyro</li>
      <li>Sell, rent or sub-license material from Tyro</li>
      <li>Reproduce, duplicate or copy material from Tyro</li>
      <li>Redistribute content from Tyro</li>
    </ul>
    <p>This Agreement shall begin on the date hereof.</p>
    <p>
      Parts of this website offer an opportunity for users to post and exchange
      opinions and information in certain areas of the website. Tyro-App does
      ...
      Tyro-App,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent
      permitted by applicable laws, Tyro-App shall not be liable for the
    ...
    <p>
      Tyro-App reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant Tyro-App a non-exclusive license to use, reproduce, edit
    ...
    <p>
      ...
      hyperlink compensates the absence of Tyro-App; and (d) the link is in the
    ...
    <p>
      ...
      e-mail to Tyro-App. Please include your name, your organization name,
    ...
    <p>
      No use of Tyro-App’s logo or other artwork will be allowed for linking
